// Word database for different topics
...
// Get random word from a topic
export const getRandomWord = (topic, usedWords = []) => {
  const words = wordDatabase[topic] || wordDatabase.general;
...
// Get word count for a topic
export const getWordCount = (topic) => {
  return wordDatabase[topic]?.length || 0;
};
